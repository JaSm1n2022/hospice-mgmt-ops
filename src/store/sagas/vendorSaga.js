...
import {
  VENDOR_ACTIONS,
  setCreateVendorFailure,
  setCreateVendorSucceed,
  setDeleteVendorFailure,
  setDeleteVendorSucceed,
  setFetchVendorFailure,
  setFetchVendorSucceed,
  setUpdateVendorFailure,
  setUpdateVendorSucceed,
...
function* createVendor(rqst) {
  try {
    ...
    if (error) {
      yield put(
        setCreateVendorFailure(`[create Vendor] : ${error.toString()}`)
      );
      throw error;
    }
...
function* updateVendor(rqst) {
  try {
    ...
    if (error) {
      yield put(
        setUpdateVendorFailure(`[update Vendor] : ${error.toString()}`)
      );
      throw error;
    }
...
function* deleteVendor(rqst) {
  try {
    ...
    if (error) {
      yield put(
        setDeleteVendorFailure(`[delete Vendor] : ${error.toString()}`)
      );
      throw error;
    }
