...
import {
  STOCK_ACTIONS,
  setCreateStockFailure,
  setCreateStockSucceed,
  setDeleteStockFailure,
  setDeleteStockSucceed,
  setFetchStockFailure,
  setFetchStockSucceed,
  setUpdateStockFailure,
  setUpdateStockSucceed,
