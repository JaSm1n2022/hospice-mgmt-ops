...
function DmeOrderDocument(props) {
                ...
                <Page size="A4" style={styles.page} orientation="portrait" wrap>
                  ...
                  <View style={styles.viewStyle}>
                    ...
                    <View style={styles.leftLineText}>
                      <Text>
                        {" "}
                        {moment(new Date(printData.deliveryDt))
                          .utc()
                  ...
                  <View style={styles.viewStyle}>
                    ...
                    <View style={styles.leftLineText}>
                      <Text>{printData?.vendor?.name}</Text>
                    </View>
                  </View>
                  <View style={styles.viewStyle}>
                    <View style={styles.titleText}>
                  ...
                  <View style={styles.viewStyle}>
                    ...
                    <View style={styles.leftLineText}>
                      <Text>{printData?.serviceLocation}</Text>
                    </View>
                  </View>
                  <View style={styles.viewStyle}>
                    <View style={styles.titleText}>
                  ...
                  <View style={styles.viewStyle}>
                    ...
                    <View style={styles.leftLineText}>
                      <Text>{printData?.contactName}</Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.leftLineTextNoBorder}>
                    <Text>Delivery Notes: {printData?.deliveryNotes}</Text>
                  </View>
                </Page>
              </Document>
            </PDFViewer>
...
export default connect(mapStateToProps, null)(DmeOrderDocument);
