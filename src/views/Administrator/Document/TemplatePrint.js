                      ...
                      return (
                        <TableRow className={classes.tableRow}>
                          ...
                          <TableCell
                            ...
                            scope="row"
                          >
                            {details && details.length && details.length > map
                              ? details[map].search.shortDescription ||
                                details[map].search.short_description
                              : ""}
                          </TableCell>
                          <TableCell
                            className={classes.tableCell}
                          ...
                          >
                            {details && details.length && details.length > map
                              ? unitDistributionHandler(
                                  details[map].orderQty,
                                  details[map].search.unitDistribution ||
                                    details[map].search.unit_distribution ||
                                    details[map].unit_distribution
                                )
                              : ""}
                          </TableCell>
                        </TableRow>
