...
const COMMENT_OPTIONS = [
  ...
  { value: "Patient Hospitalized", label: "Client Hospitalized", name: "Client Hospitalized", description: "Client Hospitalized" },
  { value: "Patient Unavailable / Not Home", label: "Client Unavailable / Not Home", name: "Client Unavailable / Not Home", description: "Client Unavailable / Not Home" },
  { value: "Visit Rescheduled", label: "Visit Rescheduled", name: "Visit Rescheduled", description: "Visit Rescheduled" },
  { value: "Patient Deceased", label: "Client Deceased", name: "Client Deceased", description: "Client Deceased" },
  { value: "Patient on Vacation / Out of Town", label: "Client on Vacation / Out of Town", name: "Client on Vacation / Out of Town", description: "Client on Vacation / Out of Town" },
  ...
  { value: "Wrong Address / Unable to Locate Patient", label: "Wrong Address / Unable to Locate Client", name: "Wrong Address / Unable to Locate Client", description: "Wrong Address / Unable to Locate Client" },
  { value: "Patient Transferred to Facility", label: "Client Transferred to Facility", name: "Client Transferred to Facility", description: "Client Transferred to Facility" },
...
function RoutesheetForm(props) {
  ...
  const validateFormHandler = () => {
    ...
    if (params.serviceRateType?.toLowerCase() === "hourly") {
      const durationMinutes = dosEndCombined.diff(dosStartCombined, "minutes");
    ...
    console.log("[FINAL ESTIMATED PAYMENT]", {
