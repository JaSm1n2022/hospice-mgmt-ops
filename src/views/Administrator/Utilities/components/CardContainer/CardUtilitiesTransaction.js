...
const CardUtilitiesTransaction = (props) => {
            ...
            <div>
              <div style={{ paddingTop: 100 }}>
                <Typography variant="h6">
                  CARD/CASH/BANK PAYMENT HISTORY REPORT (UTILITIES)
                </Typography>
              </div>
                        ...
                        return (
                          <TableRow className={classes.tableRow}>
                            ...
                            <TableCell
                              ...
                              component="th"
                              scope="row"
                            >{`$${parseFloat(map.nvEnergySte81 || 0.0).toFixed(
                              2
                            )}`}</TableCell>
                            <TableCell
                              className={classes.tableCell}
                              ...
                              component="th"
                              scope="row"
                            >{`$${parseFloat(map.nvEnergySte85 || 0.0).toFixed(
                              2
                            )}`}</TableCell>
                            <TableCell
                              className={classes.tableCell}
                              ...
                              component="th"
                              scope="row"
                            >{`$${parseFloat(map.cox || 0.0).toFixed(
                              2
                            )}`}</TableCell>
                            <TableCell
                              className={classes.tableCell}
...
export default CardUtilitiesTransaction;
