...
const CardMarketingTransaction = (props) => {
            ...
            <div>
              <div style={{ paddingTop: 100 }}>
                <Typography variant="h6">
                  CARD/CASH/BANK PAYMENT HISTORY REPORT (MARKETING EXPENSES)
                </Typography>
              </div>
                        ...
                        return (
                          <TableRow className={classes.tableRow}>
                            ...
                            <TableCell
                              ...
                              component="th"
                              scope="row"
                            >{`$${parseFloat(map.imprint || 0.0).toFixed(
                              2
                            )}`}</TableCell>
                            <TableCell
                              className={classes.tableCell}
                              ...
                              component="th"
                              scope="row"
                            >{`$${parseFloat(map.discountMugs || 0.0).toFixed(
                              2
                            )}`}</TableCell>
                            <TableCell
                              className={classes.tableCell}
                              ...
                              component="th"
                              scope="row"
                            >{`$${parseFloat(map.vistaPrint || 0.0).toFixed(
                              2
                            )}`}</TableCell>
                            <TableCell
                              className={classes.tableCell}
                              ...
                              component="th"
                              scope="row"
                            >{`$${parseFloat(map.banners || 0.0).toFixed(
                              2
                            )}`}</TableCell>
                            <TableCell
                              className={classes.tableCell}
...
export default CardMarketingTransaction;
