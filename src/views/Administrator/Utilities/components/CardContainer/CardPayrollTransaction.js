...
const CardPayrollTransaction = (props) => {
            ...
            <div>
              <div style={{ paddingTop: 100 }}>
                <Typography variant="h6">
                  CARD/CASH/BANK PAYMENT HISTORY REPORT (PAYROLL)
                </Typography>
              </div>
                        ...
                        return (
                          <TableRow className={classes.tableRow}>
                            ...
                            <TableCell
                              ...
                              component="th"
                              scope="row"
                            >{`$${parseFloat(map.idg || 0.0).toFixed(
                              2
                            )}`}</TableCell>
                            <TableCell
                              className={classes.tableCell}
                              ...
                              component="th"
                              scope="row"
                            >{`$${parseFloat(map.fullTime || 0.0).toFixed(
                              2
                            )}`}</TableCell>
                            <TableCell
                              className={classes.tableCell}
                              ...
                              component="th"
                              scope="row"
                            >{`$${parseFloat(map.perDiem || 0.0).toFixed(
                              2
                            )}`}</TableCell>
                            <TableCell
                              className={classes.tableCell}
                              ...
                              component="th"
                              scope="row"
                            >{`$${parseFloat(map.partTime || 0.0).toFixed(
                              2
                            )}`}</TableCell>
...
export default CardPayrollTransaction;
