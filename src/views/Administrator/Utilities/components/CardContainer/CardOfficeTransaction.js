...
const CardOfficeTransaction = (props) => {
            ...
            <div>
              <div style={{ paddingTop: 100 }}>
                <Typography variant="h6">
                  CARD/CASH/BANK PAYMENT HISTORY REPORT (OFFICE SUPPLIES)
                </Typography>
              </div>
                        ...
                        return (
                          <TableRow className={classes.tableRow}>
                            ...
                            <TableCell
                              ...
                              component="th"
                              scope="row"
                            >{`$${parseFloat(map.costco || 0.0).toFixed(
                              2
                            )}`}</TableCell>
...
export default CardOfficeTransaction;
