  ...
  useEffect(() => {
    if (
      ...
      const record = [...props.transactions.data].filter(
        (p) => p.category.toLowerCase() === "marketing"
      );
      console.log(
        "[record]",
        record[0],
  ...
  return (
    <React.Fragment>
      <Grid justifyContent="space-between" container style={{ padding: 10 }}>
        <Typography variant="h5">Marketing Expenses Report</Typography>
        <Box
          style={{
            padding: 2,
            background: "#ebedeb",
      ...
      <Grid justifyContent="space-between" container style={{ padding: 10 }}>
        <Typography variant="body1" color="textSecondary">
          Marketing reports, including advertising expenses, promotional
          expenses, marketing collateral,digital marketing expenses and more.
        </Typography>
      </Grid>
