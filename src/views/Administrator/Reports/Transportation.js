  ...
  useEffect(() => {
    if (
      ...
      const record = [...props.transactions.data].filter((p) =>
        ["transportation"].includes(p.category.toLowerCase())
      );
  ...
  return (
    <React.Fragment>
      <Grid justifyContent="space-between" container style={{ padding: 10 }}>
        <Typography variant="h5">Transportation Expenses Report</Typography>
        <Box
          style={{
            padding: 2,
            background: "#ebedeb",
      ...
      <Grid justifyContent="space-between" container style={{ padding: 10 }}>
        <Typography variant="body1" color="textSecondary">
          Transportation reports, including medical transport vehicles and
          ambulance services.
        </Typography>
      </Grid>
