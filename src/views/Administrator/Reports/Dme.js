...
const Dme = (props) => {
  ...
  useEffect(() => {
    if (
      ...
      const record = [...props.transactions.data].filter((p) =>
        ["dme"].includes(p.category.toLowerCase())
      );
  ...
  return (
    <React.Fragment>
      <Grid justifyContent="space-between" container style={{ padding: 10 }}>
        <Typography variant="h5">DME Expenses Report</Typography>
        <Box
          style={{
            padding: 2,
            background: "#ebedeb",
      ...
      <Grid justifyContent="space-between" container style={{ padding: 10 }}>
        <Typography variant="body1" color="textSecondary">
          DME reports, including mobility aids, bathroom safety equipment, beds
          and accessories, patient lifts and slings, respiratory equipment, and
          more.
        </Typography>
      </Grid>
...
export default connect(mapStateToProps, mapDispatchToProps)(Dme);
