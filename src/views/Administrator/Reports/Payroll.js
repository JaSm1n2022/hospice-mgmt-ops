  ...
  useEffect(() => {
    if (
      ...
      const record = [...props.transactions.data].filter(
        (p) => p.category.toLowerCase() === "payroll"
      );
      console.log(
        "[record]",
        record[0],
  ...
  return (
    <React.Fragment>
      <Grid justifyContent="space-between" container style={{ padding: 10 }}>
        <Typography variant="h5">Payroll Expenses Report</Typography>
        <Box
          style={{
            padding: 2,
            background: "#ebedeb",
      ...
      <Grid justifyContent="space-between" container style={{ padding: 10 }}>
        <Typography variant="body1" color="textSecondary">
          Payroll reports, including clinician staff payroll, office staff
          payroll, and administrative staff payroll.
        </Typography>
      </Grid>
