  ...
  useEffect(() => {
    if (
      ...
      const record = [...props.transactions.data].filter((p) =>
        ["medical/incontinence"].includes(p.category.toLowerCase())
      );
    ...
    <React.Fragment>
      ...
      <Grid justifyContent="space-between" container style={{ padding: 10 }}>
        <Typography variant="body1" color="textSecondary">
          ...
          and briefs, pull-up underwear, underpads, wound care products,
          catheters and accessories, wipes, gloves, and more.
        </Typography>
      </Grid>
