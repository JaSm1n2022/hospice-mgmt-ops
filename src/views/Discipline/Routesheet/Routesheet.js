...
const COMMENT_OPTIONS = [
  ...
  { value: "Patient Hospitalized", label: "Client Hospitalized" },
  { value: "Patient Unavailable / Not Home", label: "Client Unavailable / Not Home" },
  { value: "Visit Rescheduled", label: "Visit Rescheduled" },
  { value: "Patient Deceased", label: "Client Deceased" },
  { value: "Patient on Vacation / Out of Town", label: "Client on Vacation / Out of Town" },
  { value: "Caregiver Cancelled", label: "Caregiver Cancelled" },
  { value: "Weather / Road Conditions", label: "Weather / Road Conditions" },
  { value: "Wrong Address / Unable to Locate Patient", label: "Wrong Address / Unable to Locate Client" },
  { value: "Patient Transferred to Facility", label: "Client Transferred to Facility" },
