...
export const OVERHEAD_CONSTANTS = {
  ...
  PHARMACY_RATE: 200.0,
  DME_DAILY_RATE: 4.75,
  PAYROLL_TAX_RATE: 0.076,
  BILLING_FEE_RATE: 0.03,
  BILLING_FEE_MINIMUM: 500.0,
  MARKETING_PER_SOC: 2500.0,
  TRANSPORTATION_PER_SOC: 165.0,
  MEDICARE_SEQ_ADJ: 2.0,
  ONCALL_WEEKDAY_HOURS: 75.0,
  ONCALL_WEEKEND_HOURS: 48.0,
  ONCALL_WEEKDAY_RATE: 3.0,
  ONCALL_WEEKEND_RATE: 4.0,
  POTENTIAL_ADMISSION: 800.0,
  RENT_OFFICE: 1065.0,
  UTILITIES: 100.0,
  OFFICE_SUPPLIES: 300.0,
  LIABILITY_INSURANCE: 300.0,
  SOFTWARE_EHR: 217.0,
...
export const QA_TYPE = [
  ...
  },
  {
    id: "msw-assessment",
    name: "MSW Assessment",
    label: "MSW Assessment",
    value: "MSW Assessment",
    code: "msw-assessment",
    category: "qaType",
  },
  {
  ...
  {
    id: "msw-recertification",
    name: "MSW Recertification",
    label: "MSW Recertification",
    value: "MSW Recertification",
    code: "msw-recertification",
    category: "qaType",
  },
  {
    id: "sc-recertification",
    name: "SC Recertification",
    label: "SC Recertification",
    value: "SC Recertification",
    code: "sc-recertification",
    category: "qaType",
  },
  {
    id: "rn-recertification",
    name: "RN Recertification",
    label: "RN Recertification",
    value: "RN Recertification",
    code: "rn-recertification",
    category: "qaType",
  },
  {
    id: "rn-visit",
